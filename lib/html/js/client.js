...
//  var templates = resource.getTemplatesTag();
  ...
  var testResource = new Resource('http://id.feedface.de/me',data);
  console.log('Is instance of Resource: ' + (testResource instanceof Resource));
  testResource.registerNamespace('foaf','http://xmlns.com/foaf/0.1/');
  console.log('testResource: http://id.feedface.de/me');
  console.log('type: ' + testResource.type());
